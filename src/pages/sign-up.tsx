...
import { Heart, User, Phone, ArrowLeft, Moon, Sun } from "lucide-react";
                ...
                <div className="flex gap-2 p-1 bg-muted/30 rounded-lg border border-border/40">
                  {['male', 'female', 'other'].map((g) => (
                    <button
                      ...
                      type="button"
                      onClick={() => setGender(g)}
                      className={`flex-1 py-1.5 text-sm rounded-md transition-all capitalize shadow-sm ${gender === g
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Select value={countryCode} onValueChange={handleCountryCodeChange}>
                    <SelectTrigger className="w-[90px] bg-background/50 border-border/40">
